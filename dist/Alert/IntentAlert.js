...
const IntentAlert = (_a) => {
    var { intent, children, Component } = _a, props = __rest(_a, ["intent", "children", "Component"]);
    return (jsx_runtime_1.jsx(Component, Object.assign({ borderLeft: intent ? '3px solid' : null, borderColor: `intent.${intent}.default` }, props, { children: children }), void 0));
};
