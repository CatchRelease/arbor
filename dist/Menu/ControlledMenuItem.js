...
class ControlledMenuItem extends react_1.PureComponent {
    ...
    render() {
        ...
        return ((0, jsx_runtime_1.jsxs)(MenuItemComponent, Object.assign({}, Object.assign({ 'aria-selected': isSelected, alignItems: 'center', isFocused,
            isSelected, onClick: this.onSelect, onKeyPress: this.onKeyDown, role: 'option' }, this.props), { children: [(0, jsx_runtime_1.jsx)("input", Object.assign({}, { id, name, value, css: (0, polished_1.hideVisually)(), type: 'hidden' }), void 0), (0, jsx_runtime_1.jsxs)(Flex_1.default, Object.assign({ width: "100%", justifyContent: "space-between" }, { children: [(0, jsx_runtime_1.jsxs)(Flex_1.default, Object.assign({ flex: "1 0 auto", maxWidth: secondaryLabel ? `calc(100% - ${MIN_WIDTH} - ${PADDING})` : '100%' }, { children: [iconName && ((0, jsx_runtime_1.jsx)(Icon_1.default, { name: iconName, mr: "small", color: baseColor, fontSize: "16px" }, void 0)), (0, jsx_runtime_1.jsx)(Text_1.default, Object.assign({ as: "span", color: "inherit", minWidth: MIN_WIDTH, fontSize: "size4", overflow: "hidden" }, { children: label }), void 0)] }), void 0), secondaryLabel && ((0, jsx_runtime_1.jsx)(Flex_1.default, Object.assign({ pl: PADDING, overflow: "hidden", flex: "0 1 auto" }, { children: (0, jsx_runtime_1.jsx)(Text_1.default, Object.assign({ as: "span", fontSize: "size3", css: (theme) => ({
