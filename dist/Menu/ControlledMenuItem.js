...
function (_React$PureComponent) {
  ...
  function ControlledMenuItem() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ControlledMenuItem)).call.apply(_getPrototypeOf2, [this].concat(args)));
