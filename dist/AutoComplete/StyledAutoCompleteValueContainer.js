...
var StyledAutoCompleteValueContainer = function (_a) {
    var 
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    cx = _a.cx, innerProps = _a.innerProps, children = _a.children, props = __rest(_a, ["cx", "innerProps", "children"]);
    return (jsx_runtime_1.jsx(Flex_1["default"], __assign({ flex: "1", flexWrap: "wrap", gridGap: "smallest" }, __assign(__assign({}, innerProps), props), { children: children }), void 0));
};
