...
var StyledAutoCompleteMenu = function (_a) {
    var 
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    cx = _a.cx, innerProps = _a.innerProps, children = _a.children, props = __rest(_a, ["cx", "innerProps", "children"]);
    return (jsx_runtime_1.jsx(Card_1["default"], __assign({ mt: "smaller", position: "absolute", top: "100%", zIndex: "1" }, __assign(__assign({}, innerProps), props), { children: children }), void 0));
};
