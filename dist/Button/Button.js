...
const Button = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(StyledButton_1.default, Object.assign({}, Object.assign({ bg, className: `button--${variant}`, disabled,
        fullWidth,
        iconEnd,
        iconStart,
        intent,
        ...
        size,
        type,
        variant }, props), { children: [spin && (0, jsx_runtime_1.jsx)(ButtonSpinner_1.default, Object.assign({}, { disabled, intent, size, variant }), void 0), (0, jsx_runtime_1.jsxs)(ButtonContent_1.default, Object.assign({}, { hasText: !!children, iconStart, iconEnd, spin }, { children: [iconStart, children && ((0, jsx_runtime_1.jsx)(Text_1.default, Object.assign({ color: "inherit", fontSize: "inherit" }, { children: children }), void 0)), iconEnd] }), void 0)] }), void 0));
});
