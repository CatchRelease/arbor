...
const RadioButton = (_a) => {
    ...
    return (jsx_runtime_1.jsxs(RadioButtonLabel_1.default, Object.assign({ alignItems: "center", my: "regular" }, props, { children: [jsx_runtime_1.jsx(RadioButtonInput_1.default, { id: id, type: "radio", name: name, value: value, checked: checked, onChange: onChange, disabled: disabled, "aria-invalid": isInvalid }, void 0), jsx_runtime_1.jsx(StyledRadioButton_1.default, Object.assign({}, { disabled, checked }, { children: jsx_runtime_1.jsx(RadioButtonIcon_1.default, Object.assign({}, { checked }), void 0) }), void 0), icon && (jsx_runtime_1.jsx(Icon_1.default, { fontSize: "24px", name: icon, color: disabled ? 'icon.disabled' : 'icon.default', ml: "smaller" }, void 0)), jsx_runtime_1.jsx(Text_1.default, Object.assign({ as: "span", fontSize: "size4", color: disabled ? 'text.disabled' : 'text.default', ml: icon ? 'smallest' : 'smaller' }, { children: label }), void 0)] }), void 0));
};
