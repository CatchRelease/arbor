...
const disabledStyles = (theme) => react_1.css `
  background: ${theme.colors.background.default};
`;
const focusedStyles = (theme) => react_1.css `
  border: ${theme.borderWidth.small} solid ${theme.colors.intent.brand.dark};
  box-shadow: 0 0 8px ${polished_1.transparentize(0.9, theme.colors.intent.brand.light)};
  outline: none;
`;
const invalidStyles = (theme) => react_1.css `
  border: ${theme.borderWidth.small} solid ${theme.colors.palette.red.default};
  background: ${theme.colors.palette.red.lighter};
`;
/* stylelint-disable property-no-vendor-prefix */
const hideArrowsStyles = react_1.css `
...
`;
const inputStyles = ({ hideArrows, isDisabled, isFocused, isInvalid, theme }) => react_1.css `
