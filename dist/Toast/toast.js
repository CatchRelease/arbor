...
const buildToast = (intent) => (message, details, toastifyOptions = {}) => {
    const toastId = react_toastify_1.toast(jsx_runtime_1.jsx(Alert_1.ToastAlert, { details: details, intent: intent, message: message, onClose: () => react_toastify_1.toast.dismiss(toastId) }, void 0), toastifyOptions);
};
