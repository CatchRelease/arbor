...
function (_React$Component) {
  ...
  _createClass(AccordionSection, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("section", null, _react["default"].createElement(_AccordionHeader["default"], _extends({
        isOpen: this.isOpen,
        note: headerNote,
        ...
        text: header,
        variant: variant
      }, props)), _react["default"].createElement(_AccordionPanel["default"], {
        id: panelId,
        isOpen: this.isOpen,
        variant: variant
      }, children));
