  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["children", "menuItems", "selected"]);

      var isOpen = this.popover.current && this.popover.current.state.isOpen;

      var menu = _react.default.createElement(_.Menu, _extends({
        menuItems: menuItems,
        selected: selected
      }, {
        ref: this.menu,
      ...
      return _react.default.createElement(_.Popover, {
        ref: this.popover,
        content: menu
      }, _react.default.createElement(_.Button, _extends({}, props, {
        ref: this.button,
        "aria-haspopup": true,
